...
Before steering a lane to touch a pull request branch, verify its forge identity and exclusive ownership, then apply the upstream contribution boundary in [`docs/fork-house-branch.md`](docs/fork-house-branch.md), including its prior-art gate before any outside-repository PR or issue publication.
