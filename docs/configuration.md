...
Before publication, GitHub and GitLab changed-file APIs provide the published scratch backstop; Gerrit relies on the worker scratch preflight (`fm-pr-body-preflight.sh --scratch`) and the existing ready gate.
