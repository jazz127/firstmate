...
11. Never use shell `&` for watcher supervision.
 ...
 Routine outcomes remain hidden and turn-free under docs/pi-supervision-branch.md's presentation contract; do not turn them into unsolicited chat updates or shipshape replies.
