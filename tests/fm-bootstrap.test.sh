...
codex Luna seat is accepted in use and default^{"rules":[{"when":"big feature","use":{"harness":"codex","model":"gpt-5.6-luna","seat":"luna"}}],"default":{"harness":"codex","seat":"luna"}}^empty^
unknown use seat is refused^{"rules":[{"when":"big feature","use":{"harness":"codex","seat":"other"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unsupported use profile seat (only luna on codex): other
unknown default seat is refused^{"default":{"harness":"codex","seat":"other"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unsupported default profile seat (only luna on codex): other
Luna seat on another harness is refused^{"default":{"harness":"claude","seat":"luna"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unsupported default profile seat (only luna on codex): luna
