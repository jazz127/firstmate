...
SPRITE="$ROOT/.pi/extensions/lib/fm-calm-working-ship-sprite.ts"
...
test_home_resolution() {
  ...
  cp -L "$PRESERVATION" "$fixture/project/.pi/extensions/lib/fm-calm-preservation.ts"
  ...
  cp -L "$SPRITE" "$fixture/project/.pi/extensions/lib/fm-calm-working-ship-sprite.ts"
...
test_rendering_and_session_lifecycle() {
  ...
  cp -L "$PRESERVATION" "$fixture/lib/fm-calm-preservation.ts"
  ...
  cp -L "$SPRITE" "$fixture/lib/fm-calm-working-ship-sprite.ts"
...
test_operational_followup_turn_e2e() {
  ...
  cp -L "$PRESERVATION" "$project/.pi/extensions/lib/fm-calm-preservation.ts"
  ...
  cp -L "$SPRITE" "$project/.pi/extensions/lib/fm-calm-working-ship-sprite.ts"
